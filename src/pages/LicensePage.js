...
class LicensePage extends Component {
  componentDidMount() {
    this.props.dispatch(open_menu("license"));
    this.props.dispatch(open_main_menu("license"));
    this.props.dispatch(change_breadcrum("License Types"));
  }
  render() {
    return (
      <div>
...
export default connect(mapStoreToProps)(LicensePage);
