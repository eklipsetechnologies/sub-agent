...
import PerfReContainer from '../components/settings/per_recommend/PerfReContainer';
import { submenu } from '../store/actions/SubMenu';

class SettingsPerfRec extends Component {

    componentDidMount(){
        this.props.dispatch(open_menu('Control'));
        this.props.dispatch(open_main_menu('Control'));
        this.props.dispatch(change_breadcrum('Performance Recommendations'));
...
export default connect(mapStoreToProps) (SettingsPerfRec);