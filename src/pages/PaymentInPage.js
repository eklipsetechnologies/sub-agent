...
class PaymentInPage extends Component {
  componentDidMount() {
    this.props.dispatch(open_menu("payment information"));
    this.props.dispatch(open_main_menu("payment information"));
    this.props.dispatch(change_breadcrum("Payment Information"));
  }
  render() {
    return (
      <div>
...
export default connect(mapStoreToProps)(PaymentInPage);
