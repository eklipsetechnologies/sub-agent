...
class DependantModal extends Component {
    constructor(props) {
        super(props);
        this.state={
            style:"",
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/profile/editDependant`,{
                token:token,
            ...
            <div>
                ...
                <div className="modal-dialog " role="document">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title">{this.state.switch === "WHOCODED"? this.props.data.userDetails.employee === 2 ? "Request Edit":' Edit' :''} Dependant</h5>
...
export default connect(mapStateToProps) (DependantModal);