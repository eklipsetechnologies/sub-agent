    ...
    LoadData=()=>{
      ...
      handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/leave/HRAcceptance`,{
                token:token,
     ...
     LoadMailData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.get(`${Home}auth/leave/viewRespEmail`,{
               params:{token:token}
            })
           .then(res => {
           console.log(res);
    ...
    render() {
        ...
        return (
            ...
            <div className="row">
                ...
                <h6 class="lh-5 mg-b-0">Leave Response Mail</h6>
                </div>
        ...
        <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    <div className="col-md-5">
                    <h6 class="lh-5 mg-b-0">Respond to leave request</h6>
                    </div>
                    <div className="col-md-7">
                    <div className="pull-right">
                        <FadeIn duration="1s" timingFunction="ease-out">
            ...
            :
                    ...
                    <div className={"form-group"}>
                                 <label>Message Body</label>
                                            ...
                                            className={`${this.state.answer === '1'?" ass  stb-s": this.state.answer==='2'?" ass stb-d":'ass'}`}
                                                ...
                                                theme={'snow'}
                                                modules={ApprovalLetter.modules}
                                                formats={ApprovalLetter.formats}
                ...
                <div className="form-group">
                    ...
                    <Spinner size={40} />
                :
                <button type="submite" className="btn btn-primary2 shadow">Send Leave Response</button>
                }
...
export default connect(mapStoreToProps) (ApprovalLetter);

ApprovalLetter.modules = {}
ApprovalLetter.modules.toolbar = [
...
/* 
 * Quill ApprovalLetter formats
 * See https://quilljs.com/docs/formats/
 */
ApprovalLetter.formats = [
