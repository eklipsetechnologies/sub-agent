...
class ListU extends Component {
  ...
  LoadData = () => {
    ...
    if (localStorage.getItem("userToken")) {
      token = JSON.parse(localStorage.getItem("userToken"));
      this.setState({ loading: true });
      Axios.get(`${Home}auth/settings/listUser`, {
        params: { token: token },
      })
        .then((res) => {
          console.log(res);
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-5">
                  <h6 class="lh-5 mg-b-0">List of users</h6>
                </div>
                            ...
                            <div>
                              <FadeIn duration="1s" timingFunction="ease-out">
                                <div className=" d-flex">
                                  ...
                                  {/* <button onClick={()=>this.Delete(dep.id)} className="btn btn-danger m-1 shadow"><Trash2 color="white" size={35} /> </button> */}
                                </div>
                              </FadeIn>
                            </div>
                          </td>
...
export default connect(mapStoreToProps)(ListU);
