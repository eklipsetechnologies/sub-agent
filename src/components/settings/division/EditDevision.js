...
class EditDevision extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singleDivision`,{
               token: token,
           ...
           this.setState({fetching:false,
            ...
            if (res.data.success) {
                this.setState({name:res.data.name,department:res.data.department});
            }else{
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editDivision`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Edit division</h6>
                    </div>
...
export default connect(mapStoreToProps) (EditDevision);