...
class AddDevision extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/CreateDivision`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Add new division</h6>
                    </div>
...
export default connect(mapStoreToProps) (AddDevision);