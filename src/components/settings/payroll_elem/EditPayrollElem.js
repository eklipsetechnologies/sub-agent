...
class EditPayrollElem extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singleSkills`,{
               token: token,
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editSkills`,{
                token:token,
...
export default connect(mapStoreToProps) (EditPayrollElem);