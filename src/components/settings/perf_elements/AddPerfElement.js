...
class AddPerfElement extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/CreatePerformanceElement`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Add new performance elements</h6>
                    </div>
...
export default connect(mapStoreToProps) (AddPerfElement);