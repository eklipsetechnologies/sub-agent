...
class EditPerfElement extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singlePerformanceElement`,{
               token: token,
           ...
           this.setState({fetching:false,
            ...
            if (res.data.success) {
                this.setState({name:res.data.name,percent:res.data.percent});
            }else{
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editPerformanceElement`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Edit performance elements</h6>
                    </div>
            ...
            :
                <form onSubmit={this.handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        <label>Percentage(%) in number</label>
                        <input 
                        required
                        type="number"
...
export default connect(mapStoreToProps) (EditPerfElement);