    ...
    Delete(key){
        if (window.confirm('❌ are you sure you want to delete this branch?')) {
            ...
            if (localStorage.getItem('userToken')) {
                ...
                Axios.post(`${Home}auth/settings/deleteBranch`,{
                token: token,
                id:key
                })
            .then(res => {
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">List of branches</h6>
                    </div>
                                        ...
                                        <div>
                                            <FadeIn duration="1s" timingFunction="ease-out">
                                                <div className=" d-flex">
                                                    <button onClick={()=>this.SwitchContent('branch_edit',[dep.id])} className="btn btn-primary2 btn-sm m-1 shadow"><Edit color="white" size={35} /> </button>
...
export default connect(mapStoreToProps) (ListBranches);