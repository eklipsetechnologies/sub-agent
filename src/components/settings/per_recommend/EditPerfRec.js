...
class EditPerfRec extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singlePerfRecommendation`,{
               token: token,
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editPerfRecommendation`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Edit Performance recommendations</h6>
                    </div>
...
export default connect(mapStoreToProps) (EditPerfRec);