...
class EditActions extends Component {
    ...
    LoadData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singleDisciplineAction`,{
               token: token,
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editDisciplineAction`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Edit Disciplinary Actions</h6>
                    </div>
...
export default connect(mapStoreToProps) (EditActions);