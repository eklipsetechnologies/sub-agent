...
class AddSecurity extends Component {
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/CreateSecurityQuestion`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Add new security question</h6>
                    </div>
                ...
                <form onSubmit={this.handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        ...
                        <Spinner size={40} />
                    :
                    <button className="btn btn-primary2 shadow">Create new security question</button>
                    }
...
export default connect(mapStoreToProps) (AddSecurity);