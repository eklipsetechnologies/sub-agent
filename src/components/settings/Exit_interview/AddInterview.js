...
class AddInterview extends Component {
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/exit/CreateInterView`,{
                token:token,
                name:this.state.name2,
                exitReason:this.state.job,
        ...
        :''}
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Create a new exit interview</h6>
                    </div>
                ...
                <form onSubmit={this.handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        <label>Select exit reason</label>
                        <select 
                        required
                    ...
                    <div className="form-group">
                        ...
                        <Spinner size={40} />
                    :
                    <button className="btn btn-primary2 shadow">Create exit interview</button>
                    }
...
export default connect(mapStoreToProps) (AddInterview);