...
class EditBranches extends Component {
    ...
    LoadViewData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/singleBranch`,{
               token: token,
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/settings/editBranch`,{
                token:token,
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Edit branch</h6>
                    </div>
...
export default connect(mapStoreToProps) (EditBranches);