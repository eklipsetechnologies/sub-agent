    ...
    Delete(key){
        if (window.confirm('❌ are you sure you want to delete this job?')) {
            ...
            if (localStorage.getItem('userToken')) {
                ...
                Axios.post(`${Home}auth/settings/deleteJobs`,{
                token: token,
                id:key
                })
            .then(res => {
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">List of our jobs</h6>
                    </div>
                    <div className="col-md-7">
                        <div className="pull-right">
                        <FadeIn duration="1s" timingFunction="ease-out">
                           <button onClick={()=>this.SwitchContent('job_add',[0])} className="btn btn-primary2 btn-sm shadow"><PlusCircle color="white" size={35} /> Add New</button>
                        </FadeIn>
                                        ...
                                        <div>
                                            <FadeIn duration="1s" timingFunction="ease-out">
                                                <div className=" d-flex">
                                                    <button onClick={()=>this.SwitchContent('job_edit',[dep.id])} className="btn btn-primary2 btn-sm m-1 shadow"><Edit color="white" size={35} /> </button>
