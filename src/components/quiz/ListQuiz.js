            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-5">
                  <h6 class="lh-5 mg-b-0">Quiz Questions</h6>
                </div> 
                <div className="col-md-7">
                  <div className="pull-right">
                    <FadeIn duration="1s" timingFunction="ease-out">
                    <button
                    onClick={()=>this.SwitchContent("add_quiz",0)}
                          ...
                          <td>
                            {dep.options && dep.options.length > 0 &&(
                                dep.options.map((list,index)=>
                                    <span key={index} className="badge badge-primary badge-pill m-1">{list.value}</span>
                                    )
                            )}
                            </td>

                          <td>{dep.answer.value}</td>
                          {/* <td>{dep.address}</td> */}
                          <td>
                            <div>
                              <FadeIn duration="1s" timingFunction="ease-out">
...
export default connect(mapStoreToProps)(ListQuiz);
