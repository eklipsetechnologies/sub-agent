...
class AddQuery extends Component {
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/query/Create`,fd,{
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <form onSubmit={this.handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        <label>Subject for querry</label>
                        <input 
                        required
                        // placeholder="Subject for querry"
                    ...
                    <div className="form-group">
                        ...
                        <Spinner size={40} />
                    :
                    <button className="btn btn-primary2 shadow">Create querry</button>
                    }
...
export default connect(mapStoreToProps) (AddQuery);