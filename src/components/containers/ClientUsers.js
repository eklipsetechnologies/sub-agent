            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-5">
                  <h6 class="lh-5 mg-b-0">Experts users for {this.props.data.params.length > 1? this.props.data.params[1]:''}</h6>
                </div> 
                            ...
                            <div>
                              <FadeIn duration="1s" timingFunction="ease-out">
                                ...
                                <button
                                    ...
                                    <button
                                      data-rh="Remove Expert from client"
                                      onClick={() => this.UnMatchNow(dep.id)}
...
export default connect(mapStoreToProps)(ClientUsers);
