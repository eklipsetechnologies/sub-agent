...
class ExitFinalAdviseMail extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
      ...
      handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/exit/sendFinalAdviceEmail`,{
                token:token,
     ...
     LoadMailData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.get(`${Home}auth/exit/viewFinalAdviceEmail`,{
               params:{token:token}
            })
           .then(res => {
        //    console.log(res);
    ...
    render() {
        ...
        <BounceUp duration="1s" timingFunction="ease-out">
               ...
               <div className="row">
                   ...
                   <h6 class="lh-5 mg-b-0">Final advise to Employee</h6>
                   </div>
           ...
           :
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    <div className="col-md-5">
                    <h6 class="lh-5 mg-b-0">Sent final advise to Employee</h6>
                    </div>
                    <div className="col-md-7">
                    <div className="pull-right">
                        <FadeIn duration="1s" timingFunction="ease-out">
                    ...
                    <div className="form-group">
                                 <label>Message Body</label>
                                            <ReactQuill 
                                                ...
                                                theme={'snow'}
                                                modules={ExitFinalAdviseMail.modules}
                                                formats={ExitFinalAdviseMail.formats}
...
export default connect(mapStoreToProps) (ExitFinalAdviseMail);

ExitFinalAdviseMail.modules = {}
ExitFinalAdviseMail.modules.toolbar = [
...
/* 
 * Quill ExitFinalAdviseMail formats
 * See https://quilljs.com/docs/formats/
 */
ExitFinalAdviseMail.formats = [
