...
class AcMail extends Component {
    constructor(props) {
        super(props);
        this.state ={
            switch:"",
    ...
    LoadData=()=>{
      ...
      handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/exit/sendAckEmail`,{
                token:token,
     ...
     LoadMailData=()=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.get(`${Home}auth/exit/viewAckEmail`,{
               params:{token:token}
            })
           .then(res => {
           console.log(res);
    ...
    render() {
        ...
        return (
            ...
            <div className="row">
                ...
                <h6 class="lh-5 mg-b-0">Acknoledgement Mail</h6>
                </div>
                    ...
                    <div className="form-group">
                                 <label>Message Body</label>
                                            <ReactQuill 
                                                ...
                                                theme={'snow'}
                                                modules={AcMail.modules}
                                                formats={AcMail.formats}
...
export default connect(mapStoreToProps) (AcMail);

AcMail.modules = {}
AcMail.modules.toolbar = [
