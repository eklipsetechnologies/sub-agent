...
class NewAssessment extends Component {
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            Axios.post(`${Home}auth/train/CreateExcercise`,{
                token:token,
               ...
               .then(res => {
                 ...
                 if (res.data.success) {
                   ...
                   this.SwitchContent('train_list_ex',[0]);
                }else{
                    this.props.dispatch(launch_toaster(res.data.message));
        ...
        :''}
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Create a assessments</h6>
                    </div>
                    <div className="col-md-7">
                        <div className="pull-right">
                        <FadeIn duration="1s" timingFunction="ease-out">
                           <button onClick={()=>this.SwitchContent('train_list_ex',[0])} className="btn btn-danger btn-sm shadow"><ArrowLeft color="white" size={35} /> Return</button>
                        </FadeIn>
                ...
                <form onSubmit={this.handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        <label>Assessment period (in minutes)</label>
                        <input 
                        required
                        type="number"
                    ...
                    <div className="form-group">
                        ...
                        <Spinner size={40} />
                    :
                    <button className="btn btn-primary2 shadow">Create assessments</button>
                    }
...
export default connect(mapStoreToProps) (NewAssessment);