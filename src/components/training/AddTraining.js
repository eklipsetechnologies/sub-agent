...
class AddTraining extends Component {
    ...
    handleSubmit=(event)=>{
        ...
        if (localStorage.getItem('userToken')) {
            ...
            let fd = new FormData();
            fd.append('department',this.state.country);
            ...
            Axios.post(`${Home}auth/train/createCourse`,fd,{
               ...
               .then(res => {
                //  console.log(res);
                 ...
                 if (res.data.success) {
                   ...
                   this.SwitchContent('train_list_course',[0]);
                }else{
                    this.props.dispatch(launch_toaster(res.data.message));
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">Add Course/Training</h6>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <Spinner size={40} />
                    :
                    <button className="btn btn-primary2 shadow">Create Training/Course</button>
                    }
...
export default connect(mapStoreToProps) (AddTraining);