...
class FileUploader extends React.Component {
    ...
    onDownloadComplete(event) {
        // console.log('nnn: ',event.currentTarget.responseText)
        
        if (JSON.parse(event.currentTarget.responseText).success) {
            toast.success(JSON.parse(event.currentTarget.responseText).message,{
                position: "top-right",
                autoClose: 5000,
            ...
            toast.error(JSON.parse(event.currentTarget.responseText).message,{
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
