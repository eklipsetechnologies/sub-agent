...
class ProfileRequestDetails extends Component {
    constructor(props) {
        super(props);
        this.state={
            style:"",
        ...
        return (
            <div>
                ...
                <div className="modal-dialog " role="document">
                    ...
                    <button onClick={()=>this.ChangeSwitch('WHOCODED')} type="button" className="btn btn-success" data-dismiss="modal">{`${this.state.switch === 'WHOCODED'?'Close Edit':'Approve'}`}</button>
                    <button onClick={()=>this.ChangeSwitch('WHOCODED')} type="button" className="btn btn-danger" data-dismiss="modal">{`${this.state.switch === 'WHOCODED'?'Close Edit':'Decline'}`}</button>
...
export default connect(mapStateToProps) (ProfileRequestDetails);