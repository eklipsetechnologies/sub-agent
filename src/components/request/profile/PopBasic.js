...
class PopBasic extends Component {
    constructor(props) {
        super(props);
        this.state={
            style:"",
            ...
            <div>
                ...
                <div className="modal-dialog " role="document">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title">View Basic Profile Request</h5>
...
export default connect(mapStateToProps) (PopBasic);