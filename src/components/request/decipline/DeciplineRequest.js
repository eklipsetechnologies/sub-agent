...
import DecilineDetails from './DecilineDetails';

class DeciplineRequest extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            ...
            <BounceRight duration="1s" timingFunction="ease-out">
                ...
                <div className="row">
                    ...
                    <h6 class="lh-5 mg-b-0">List of deciplinary request</h6>
                    </div>
...
export default connect(mapStoreToProps) (DeciplineRequest);