...
class HRStorage extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  LoadData = () => {
    ...
    if (localStorage.getItem("userToken")) {
      token = JSON.parse(localStorage.getItem("userToken"));
      this.setState({ loading: true });
      Axios.get(`${Home}auth/userFiles2/2`, {
        params: { token: token },
      })
        .then((res) => {
          console.log(res);
              ...
              >
                <div className="modal-header">
                  <h5 className="modal-title">
                    Upload Human Resources(HR) Files
                  </h5>
                  <button
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-5">
                  <h6 class="lh-5 mg-b-0">Human Resources(HR) Saved Files</h6>
                </div>
                <div className="col-md-7">
                  <div className="pull-right">
                    <FadeIn duration="1s" timingFunction="ease-out">
                      ...
                      {/* <button onClick={()=>this.OpenModal2('WHOCODED',0)} className="btn btn-primary m-1 shadow"><PlusCircle color="white" size={35} /> New Document</button> */}
                      <button
              ...
              <div className="p-5">
                ...
                <div className="p-5">
                  <div className="alert alert-warning text-center">
                    Data Empty <a className="btn-link" onClick={this.onload}>Refresh</a>
                  </div>
                </div>
            ) : (
              <div className="p-3">
...
export default connect(mapStoreToProps)(HRStorage);
